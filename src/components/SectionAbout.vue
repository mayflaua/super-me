    ...
    <div class="about__main">
      <div class="about__basics">
        ...
        <p class="basics__subtitle">
          Стараюсь делать полезные, красивые и фунцкиональные веб-приложения с
          использованием Vue 3.
        </p>
      </div>
  ...
  data: () => ({
    cards: [
      ...
      },
      {
        ...
        text: [
          "Frontend разработкой я начал заниматься относительно недавно. В свободное от работы время я предпочитаю пешие и вело-прогулки. Вместе с тем, стараюсь поддерживать в тонусе тело и голову физической и умственной активностью.",
        ],
      },
      {
        title: "Цели",
        text: [
          "Я хочу попасть в команду единомышленников, которые смогут поделиться бесценным опытом.",
          "Моя главная цель - стать полноценным Frontend разработичком. (А может и Fullstack)",
        ],
      },
      {
        title: "Soft skills",
        text: [
          "Самостоятельно за собой я заметил навыки самообучения, мотивированности к развитию, стрессоустойчивость, эмоциональный интеллект.",
        ],
      },
      {
        title: "Hard skills",
        text: [
          ...
          "Решения, которых я коснулся - Element-Plus, kaboom.js, GSAP, SVG, jQuery, PHP",
        ],
      },
    ],
  }),
